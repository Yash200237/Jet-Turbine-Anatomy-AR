...
- **Architecture**: ARMv7 or ARM64 processor
...
1. Download the APK from the Builds section
...
3. **AR Setup**: Point your camera at our surrounding and the jet turbine model will be automatically placed virually in your environment 
4. **Interact**: Use the UI buttons to toggle different turbine components (as shown in Demo)
5. **Explore**: Move around the model to view it from different angles
